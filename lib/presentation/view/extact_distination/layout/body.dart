...
import 'package:rebooked_app/presentation/view/extact_distination/use_current_location.dart';

class ExactDestinationBody extends StatefulWidget {
  const ExactDestinationBody({super.key});

  @override
  State<ExactDestinationBody> createState() => _ExactDestinationBodyState();
}

class _ExactDestinationBodyState extends State<ExactDestinationBody> {
  ...
  Future setSourceAndDestinationIcons() async {
    final Uint8List icon1 =
        await getBytesFromAsset('assets/images/marker_g.png', 120);
        ...
        child: Column(
          ...
          children: [
            ...
            AppCustomCard(
                ...
                value: "",
                onPressed: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>const UseCurrentLocation()));
                }),
            const SizedBox(height:18,),
            Row(
              children: [
                ...
                Expanded(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      CustomText(
                        text: "GZ-183-7623, Republic of Ghana, Accra, Greater Accra ",
                        fontSize: 13,
